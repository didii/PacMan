...
public class LineSegment2DDrawer : PropertyDrawer {
    ...
    void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
        ...
        //EditorGUI.PropertyField(amountRect, property.FindPropertyRelative("Start"), GUIContent.none);
        //EditorGUI.PropertyField(unitRect, property.FindPropertyRelative("End"), GUIContent.none);
