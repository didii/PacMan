...
/// <summary>
///     A simple timer that does not create a new task, but is rather updated using <see cref="Update"/>
/// </summary>
public class SyncTimer {
    #region Fields
    private bool _enabled;
    private bool _initialRaise;
    ...
    /// </summary>
    /// <remarks>
    ///     When set to false and <see cref="InitialRaise"/> set to true, the event will fire twice. Once when
    ///     <see cref="Start"/> was called and once after <see cref="IntervalTime"/> seconds.
    /// </remarks>
    public bool Repeat {
        get { return _repeat; }
        set { _repeat = value; }
    ...
    /// <seealso cref="IgnoreMultipleStart"/>
    /// <seealso cref="RepeatCount"/>
    /// <seealso cref="InitialRaise"/>
    public void Start() {
    ...
    public void Update() {
        ...
        if (_enabled &&
            (_repeatCountMax <= 0 || _repeatCount < _repeatCountMax) &&
            Time.time > _startTime + _intervalTime) {
